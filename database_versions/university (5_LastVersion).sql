...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 04 Noi 2018 la 13:17
...
(6, 'Faculty ULBS', 1999, 'Mircea Sandala', 'str. Zaharia Boiu ,nr. 4, Sibiu, 55025, Romania'),
(7, 'Faculty UBB', 1980, 'Horia Brenciu', 'str. Dimu Stanca ,nr. 44, CLuj, 55099, Romania'),
(8, 'Faculty of Timisoara', 1966, 'Nicolae Damiel', 'str. Zanelor, nr. 78, Timisoara, 55997, Romania'),
(9, 'Faculty of RGGB', 1986, 'Gabriel Rosca', 'str. Pop Sect, nr. 14, Bucuresti, 770025, România'),
(10, 'Faculty Coventry', 1986, 'Daniel Brown', 'str. Priory, nr. CV5, London, 796311, UK');
...
--
ALTER TABLE `course`
  ADD CONSTRAINT `course_ibfk_1` FOREIGN KEY (`IDSpec`) REFERENCES `specialty` (`IDSpec`) ON DELETE CASCADE;

--
-- Restrictii pentru tabele `grade`
--
ALTER TABLE `grade`
  ADD CONSTRAINT `grade_ibfk_1` FOREIGN KEY (`IDCourse`) REFERENCES `course` (`IDCourse`) ON DELETE CASCADE,
  ADD CONSTRAINT `grade_ibfk_2` FOREIGN KEY (`IDStud`) REFERENCES `studdata` (`IDStud`) ON DELETE CASCADE;

--
-- Restrictii pentru tabele `specialty`
--
ALTER TABLE `specialty`
  ADD CONSTRAINT `specialty_ibfk_1` FOREIGN KEY (`IDFac`) REFERENCES `faculty` (`IDFac`) ON DELETE CASCADE;

--
-- Restrictii pentru tabele `student`
--
ALTER TABLE `student`
  ADD CONSTRAINT `student_ibfk_1` FOREIGN KEY (`IDStud`) REFERENCES `studdata` (`IDStud`) ON DELETE CASCADE,
  ADD CONSTRAINT `student_ibfk_2` FOREIGN KEY (`IDFac`) REFERENCES `faculty` (`IDFac`) ON DELETE CASCADE,
  ADD CONSTRAINT `student_ibfk_3` FOREIGN KEY (`IDSpec`) REFERENCES `specialty` (`IDSpec`) ON DELETE CASCADE;
COMMIT;
